/**
 * BATTELLE Message parser example
...
char *parseBattelle(char *in, char *id, char* in_time)
{
    ...
    asprintf(&buf,"%s%s%s%s",buf,"\'id\': \'", id, "\', \'messageSet\': \'BATTELLE\', ");
 ...
 * a sample BATTELLE formatted binary input string.
 * 
...
int main(int ac, char *av[])
{
    ...
    char* out= parseBattelle(in, id, time);
